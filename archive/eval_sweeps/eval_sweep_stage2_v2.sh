...
set -e
cd ~/hybridbid
LOG=logs/eval_sweep_stage2_v2.log
echo "=== Stage 2 v2 Eval Sweep ===" | tee $LOG
date | tee -a $LOG

# Checkpoints at key steps: 10k, 20k, 30k, 48k (Phase A end), 60k, 75k, 90k, 105k, 120k
for step in 10000 20000 30000 48000 60000 75000 90000 105000 120000; do
    ckpt="checkpoints/stage2_v2/checkpoint_step${step}.pt"
